...
let FilesController = class FilesController {
    ...
    uploadFile(file, projectId, sourceLanguage, targetLanguage) {
    ...
    updateSegment(segmentId, targetText) {
...
__decorate([
    ...
    __param(2, (0, common_1.Body)('sourceLanguage')),
    __param(3, (0, common_1.Body)('targetLanguage')),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get file segments' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], FilesController.prototype, "getSegments", null);
__decorate([
    (0, common_1.Patch)('segments/:segmentId'),
    (0, swagger_1.ApiOperation)({ summary: 'Update segment translation' }),
    __param(0, (0, common_1.Param)('segmentId')),
    __param(1, (0, common_1.Body)('targetText')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", void 0)
], FilesController.prototype, "updateSegment", null);
__decorate([
